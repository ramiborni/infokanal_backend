"""
Django settings for infokanal_backend project.
...
SECRET_KEY = 'django-insecure-mab)34pvex$)n54@nwhkbpw!^rzcl-p&m-@ieow5xv)tf=#5^+'
...
ROOT_URLCONF = 'infokanal_backend.urls'
...
WSGI_APPLICATION = 'infokanal_backend.wsgi.application'
